...
from timeVAE.vae.vae_dense_model import VariationalAutoencoderDense as VAE_Dense
from timeVAE.vae.vae_conv_model import VariationalAutoencoderConv as VAE_Conv
from timeVAE.vae.timevae import TimeVAE
